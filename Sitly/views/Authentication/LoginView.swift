...
struct LoginView: View {
    ...
    init() {
        ...
        self._viewModel = StateObject(wrappedValue: LoginViewModel(userUseCase: container.userUseCase))
    }
    ...
    private func login() {
        ...
        Task {
            do {
                let success = try await viewModel.login(email: email, password: password, rememberMe: rememberMe)
                if success {
